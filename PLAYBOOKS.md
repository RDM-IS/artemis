...
| Sun 09:30 | `job_health_review` (health tier, OPEN phase only) — one post per open candidate that is **new or changed** since it was last posted (`surfaced_hits/_exposures`); nothing when nothing changed. |
