...
# Weekends (Sat + Sun, local) run later: wake 07:30, business 08:30 (one
# health-only hour), quiet 22:30. Friday night still goes quiet
...
WEEKEND_OPEN_TIME = os.environ.get("WEEKEND_OPEN_TIME", "08:30")
